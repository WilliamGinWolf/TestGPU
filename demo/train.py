...
parser.add_argument('--end_epoch', type=int, default=1, help='epoch number of end training') # default=400
...
parser.add_argument('--data_dir', type=str, default='Datasets/train/myTrain', help='training data directory') # Datasets/train/DIV2K_BSD400
...
parser.add_argument('--test_name', type=str, default='myTest', help='name of test set') # Set11
