...
parser.add_argument('--end_epoch', type=int, default=2, help='epoch number of end training') # default = 100
...
parser.add_argument('--patch_size', type=int, default=32, help='from {1, 4, 10, 25, 40, 50}') # default = 64
